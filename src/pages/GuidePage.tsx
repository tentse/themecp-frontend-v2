      ...
      <div className="p-4 sm:p-6 md:p-8 nb-card">
        ...
        <ol className="list-decimal list-inside space-y-6 sm:space-y-8">
          <li className="text-sm sm:text-base text-gray-700">
            ...
            <br />
            <img src={addHandle} alt="Add handle" className="mt-2 max-w-full sm:max-w-md rounded-[5px] border-2 border-black" />
          </li>
          <li className="text-sm sm:text-base text-gray-700">
            ...
            the contest page.
            <br />
            <img src={levelSheet} alt="Level sheet" className="mt-2 max-w-full sm:max-w-md rounded-[5px] border-2 border-black" />
          </li>
          <li className="text-sm sm:text-base text-gray-700">
            ...
            <br />
            <img src={contest} alt="Contest" className="mt-2 max-w-full sm:max-w-md rounded-[5px] border-2 border-black" />
          </li>
          <li className="text-sm sm:text-base text-gray-700">
            After submitting each problem solution press the refresh button to update your solved
            progress.
            <br />
            <img src={startContest} alt="Start contest" className="mt-2 max-w-full sm:max-w-md rounded-[5px] border-2 border-black" />
          </li>
          <li className="text-sm sm:text-base text-gray-700">
            After the contest is over you can go to your profile page and view your performance and
            rating.
            <br />
            <img src={profile} alt="Profile" className="mt-2 max-w-full sm:max-w-md rounded-[5px] border-2 border-black" />
          </li>
          <li className="text-sm sm:text-base text-gray-700">
