...
export default function HomePage() {
  ...
  return (
      ...
      <div className="flex flex-col items-center justify-center py-12 sm:py-16 md:py-20">
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-6 sm:mb-8 text-center px-4">
          Welcome to Theme<span className="text-red-600">CP</span>
        </h1>
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 w-full sm:w-auto px-4 sm:px-0">
          <button
            onClick={() => navigate('/guide')}
            className="w-full sm:w-auto rounded-xl bg-black px-6 py-3 text-white font-medium hover:bg-gray-800 active:scale-95 transition-all"
          >
            Get Started
          </button>
          <button
            onClick={() => window.open('https://discord.gg/ncnut8Zw63', '_blank')}
            className="w-full sm:w-auto flex items-center justify-center gap-2 rounded-xl px-6 py-3 text-white font-medium active:scale-95 transition-all hover:opacity-90"
      ...
      <div className="max-w-3xl mx-auto p-4 sm:p-6 md:p-8 rounded-xl bg-white shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-200">
      ...
      <div className="max-w-3xl mx-auto p-4 sm:p-6 md:p-8 rounded-xl bg-white shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-200">
        <h2 className="text-xl sm:text-2xl font-bold mb-6">Why does it work?</h2>
